  ...
  <body>
    ...
    <section class="site-section">
      <div class="container">
        ...
        <div class="row">
            <div class="col-md-4">
              <a class="navbar-brand"><img src="images/ntlogo.png" width="180px" height="150px"></a>
            </div>
            <div class="heading-wrap text-center element-animate">
              <div class="col-md-12">
                <h1>Natsepa</h1>
                <h2>PEMESANAN PAKET WISATA</h2>
                <h6>Alamat: JL. Natsepa No. 84 Ambon </h6>
              </div>
              <div class="col-md-12">
                <a class="p-2"><i class="fa fa-phone"></i> (0274) 618080 / 586742</a>
                <a class="p-2"><i class="fa fa-whatsapp"></i> 0811 250 136</a>
                <a class="p-2"><span class="fa fa-envelope-square"></span> po.natsepa.tour@rocketmail.com</a>
              </div>
            </div> 
        </div><hr /><br><br>
