...
//koneksi ke database
include 'koneksi.php';
$query = $koneksi->query("SELECT * FROM tb_paketwisata_grup WHERE id_paketwisata_grup='$_POST[wisata_grup]'");
            ...
            <div class="datatable">
              <table class="table table-bordered">
                ...
                <tbody>
                  <?php
                  $nomor = 0;
                  $ambil = mysqli_query($koneksi, "SELECT * FROM tb_paketwisata JOIN tb_alternatif ON tb_paketwisata.id_paketwisata=tb_alternatif.id_paketwisata WHERE id_paketwisata_grup='$_POST[wisata_grup]'");
