...
<html lang="en">
  <head>
    ...
    <title>Natsepa - Pembatalan</title>
    <meta charset="utf-8">
  ...
  <body>
    ...
    <div class="alert alert-info">Pesanan hanya dapat dibatalkan SATU BULAN sebelum tanggal <strong><?php echo $detpem["tanggal_tour"]; ?> atau tidak ada pengembalian uang.</strong></div>
	</form>
